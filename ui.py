...
lista_columna_derecha = [[sg.Text("Listado De Datos")],
                         [sg.Listbox(data, size=(20, 9), enable_events=True, key='_LIST_')],
...
cantidad_layout = [
                [sg.Text("Sustantivos"), sg.Slider(range=(1,10),orientation="h")],
                [sg.Text("Adjetivos"), sg.Slider(range=(1,10),orientation="h")],
                [sg.Text("Verbos"), sg.Slider(range=(1,10),orientation="h")],
]
maymin_layout = [
